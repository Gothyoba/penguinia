...
def start():
	...
	print("The Frog and Mosquito occupied Islands 🐸 were invaded by Penguinia in the year 34 AP.")
	print("In the year 79 AP they declared independence and became the Republic of Lily and the Mosquito Principality (the latter was recently invaded by the former).")
	...
	match key:
		case "tut":
			...
			print("You always start the game with a sword and a potion. Currently you cannot get any new weapons or healers.")
