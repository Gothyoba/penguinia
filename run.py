...
def start():
	...
	print("You live in the nation of Penguinia, which has exited for 248 years.")
	print("Due to this, it is now the year 248 AP(after Penguinia).")
	print("You have inherited the position of underpriest at the Grand Temple of Forsteri from your mother and are relatavely wealthy.")
	print("You also work as an ice sculptor selling mildly successful masterpieces when you are not at the Grand Temple.")
	print("While you generally support the actions of Queen Quoria, you don't like the cocept of monarchy in general.")
	...
	print("Tensions strated over the ownership of the Lily Ilsands, which are a group of sparse island in the sea separating the two nations.")
	...
	print("Ever since the year 83 AP the Seal Kingdom claimed the Islands and has tried to invade them three times.")
	...
	print("Right now, it is unsure when war will arise.")
