...
Penguinia is currently in alpha, specifically on version 0.1.2. Version 0.1.3 is being developed on brnach main. In order to play penguinia, run the file run.py in a console capable of running python.
